...
To fill a field that is empty (a vocabulary row's "flags" or "pointed", a card's notes), give "field": "flags" | "pointed" | "notes" and "find": "". Otherwise "field" is "" (except on a word card, where it is "root" or "binyan").
