...
Answer with ONE JSON object and nothing else: {"guide": <the whole guide, corrected, in the same shape>, "changes": ["<one line per correction: what was wrong, and what it is now>"]}. With nothing to correct, return the guide unchanged and "changes": [].
`;
