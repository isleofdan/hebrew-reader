...
- The word cards: the user message also lists the cards already saved to Dan's map from the lesson's single words (each word's lemma, part of speech, root and binyan). Check each card's root and binyan the same way; a wrong card teaches the wrong form every time Dan taps the word.
