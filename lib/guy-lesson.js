...
function verbVerdicts(lesson, given) {
  ...
  for (const a of list(given)) {
    ...
    const v = { word: surface, verdict, root: lookup.normalizeRoot(str(a.root)) || '', binyan: lookup.BINYANIM.includes(b) ? b : '', why: str(a.why) };
...
module.exports = { applyCorrections, correctCards, restoreContradicted, confirmZinek, extract, nameAndDate, add, shapeGuide, startGuide, view, remove, saveWords, retryWord, plain, MIN_ITEMS, MAX_BYTES, NAME_PATTERN, KIND_ORDER };
